...
tokens Scanner<EncodingPolicy>::ScanRegExpConstant(ArenaAllocator* alloc)
{
    ...
    {
        pattern = parser.template CompileProgram<buildAST>(root, m_currentCharacter, totalLen, bodyChars, bodyLen, totalChars, buildAST ? flags : UnifiedRegex::NoRegexFlags);
    }
