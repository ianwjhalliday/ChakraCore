    ...
    _Out_opt_ RestorePoint* pEllipsisLocation /*= nullptr*/)
{
    ...
    case tkLParen:
    {
        ...
        pnode = ParseExpr<buildAST>(koplNo, &fCanAssign, TRUE, nullptr, nullptr /*nameLength*/, nullptr  /*pShortNameOffset*/, &pidTermId, true, nullptr, plastRParen, pEllipsisLocation);
...
void Parser::ParseExpressionLambdaBody(ParseNodePtr pnodeLambda)
{
    ...
    ParseNodePtr result = ParseExpr<buildAST>(koplAsg, nullptr, TRUE, nullptr, nullptr, nullptr, &pidTermId, false, nullptr, &lastRParen);
    ...
    _Out_opt_ RestorePoint* pEllipsisLocation)
{
    ...
    else
    {
        ...
        pnode = ParseTerm<buildAST>(TRUE, pNameHint, &hintLength, &hintOffset, &pidTermId, fUnaryOrParen, &fCanAssign, IsES6DestructuringEnabled() ? &fLikelyPattern : nullptr, &fIsDotOrIndex, plastRParen, &ellipsisLocation);
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            IdentPtr pidOperandTermId = nullptr;
            pnodeT = ParseExpr<buildAST>(opl, NULL, fAllowIn, pNameHint, &hintLength, &hintOffset, &pidOperandTermId, false, nullptr, plastRParen);
